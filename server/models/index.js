...
export const Beneficiary = mongoose.model('Beneficiary', new Schema({ owner: objectId, name: String, nickname: String, bank: String, bankCode: String, accountNumber: String, favourite: Boolean, email: String, phone: String, note: String }, { timestamps: true }))
export const Biller = mongoose.model('Biller', new Schema({ owner: { type: Schema.Types.ObjectId, ref: 'User', index: true }, visibility: { type: String, enum: ['shared', 'private'], default: 'shared' }, name: String, short: String, category: String, customerLabel: String, fee: Number, status: String }, { timestamps: true }))
